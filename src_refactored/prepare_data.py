"""
Command-line script to prepare wind speed dataset.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Prepare wind speed classification dataset")
    ...
    parser.add_argument("--output_images", type=str, default="wind_3D16X16.npy", help="Output images file")
    parser.add_argument("--output_labels", type=str, default="wind_label_3D16X16.npy", help="Output labels file")
    ...
    prepare_wind_speed_dataset(
        ...
        output_label_file=args.output_labels
    )
